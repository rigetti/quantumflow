...
# -*- coding: utf-8 -*-
#
# QuantumFlow documentation build configuration file, created by
# sphinx-quickstart on Tue Jan  9 16:28:48 2018.
#
...
htmlhelp_basename = 'QuantumFlowdoc'
...
latex_documents = [
    (master_doc, 'QuantumFlow.tex', 'QuantumFlow Documentation',
     'Gavin Crooks', 'manual'),
]
...
man_pages = [
    (master_doc, 'quantumflow', 'QuantumFlow Documentation',
     [author], 1)
]
